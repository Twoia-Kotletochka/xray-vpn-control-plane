...
Используй GitHub private vulnerability reporting или приватный контакт с maintainer. Не открывай публичный issue с exploit details, live server data, subscription URLs или credentials.
