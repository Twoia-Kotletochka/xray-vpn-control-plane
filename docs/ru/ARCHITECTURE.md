...
- restore намеренно остаётся host-side операцией через shell script, а панель даёт preflight и точные команды

## Известные Ограничения

- analytics и logs UX пока проще, чем остальная панель
...
- основной профиль транспорта: `VLESS + REALITY`; WireGuard доступен как дополнительный профиль, если включён в настройках окружения
