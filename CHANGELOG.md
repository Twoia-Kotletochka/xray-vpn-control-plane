...
- Reworked the public README and deployment docs for a clean bilingual first-use flow.
- Added `LICENSE`, `CONTRIBUTING`, issue templates, a PR template, and a Code of Conduct.
- Removed internal handoff/export files from the public tree.
- Renamed public runtime paths, package metadata, backup names, and browser storage keys to the `xray-vpn-control-plane` project identity.
