...
Use GitHub private vulnerability reporting or contact the repository maintainer privately. Do not open a public issue with exploit details, live server data, subscription URLs, or credentials.
