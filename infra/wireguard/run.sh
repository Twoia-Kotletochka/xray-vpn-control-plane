...
config_path="${WIREGUARD_CONFIG_PATH:-/var/lib/xray-vpn-control-plane/wireguard/generated/wg0.conf}"
runtime_dump_path="${WIREGUARD_RUNTIME_DUMP_PATH:-/var/lib/xray-vpn-control-plane/wireguard/runtime/wg-show.dump}"
runtime_interval_ms="${WIREGUARD_RUNTIME_SYNC_INTERVAL_MS:-60000}"
log_file="/var/log/xray-vpn-control-plane/wireguard.log"
