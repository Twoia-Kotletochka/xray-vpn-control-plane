...
describe('BackupsPage', () => {
  ...
  it('loads a restore plan before showing the restore commands', async () => {
    const backupRecord = {
      id: 'backup-1',
      fileName: 'xray-vpn-control-plane-20260324-184000Z.tar.gz',
      absolutePath: '/opt/xray-vpn-control-plane/infra/backup/output/xray-vpn-control-plane-20260324-184000Z.tar.gz',
      containerAbsolutePath: '/var/backups/xray-vpn-control-plane/xray-vpn-control-plane-20260324-184000Z.tar.gz',
      hostAbsolutePath: '/opt/xray-vpn-control-plane/infra/backup/output/xray-vpn-control-plane-20260324-184000Z.tar.gz',
      checksumSha256: 'abc',
      fileSizeBytes: '1024',
      status: 'READY',
    ...
    const listResponse: BackupListResponse = {
      items: [backupRecord],
      policy: {
        backupDir: '/var/backups/xray-vpn-control-plane',
        hostBackupDir: '/opt/xray-vpn-control-plane/infra/backup/output',
    ...
    const restorePlan: BackupRestorePlanResponse = {
      ...
      commands: {
        dryRun:
          "./infra/scripts/restore.sh --dry-run --yes-restore '/var/backups/xray-vpn-control-plane/xray-vpn-control-plane-20260324-184000Z.tar.gz'",
        restore:
          "./infra/scripts/restore.sh --yes-restore '/opt/xray-vpn-control-plane/infra/backup/output/xray-vpn-control-plane-20260324-184000Z.tar.gz'",
        verification: [
          {
            id: 'composePs',
    ...
    await screen.findByText('xray-vpn-control-plane-20260324-184000Z.tar.gz');
