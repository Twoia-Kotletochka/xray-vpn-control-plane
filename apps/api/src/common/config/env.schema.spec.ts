...
describe('validateEnv', () => {
  it('parses a valid environment object', () => {
    const env = validateEnv({
      ...
      API_LOG_FILE: '/var/log/xray-vpn-control-plane/api.log',
      ...
      XRAY_ACCESS_LOG_FILE: '/var/log/xray-vpn-control-plane/xray-access.log',
      XRAY_ERROR_LOG_FILE: '/var/log/xray-vpn-control-plane/xray-error.log',
      CADDY_ACCESS_LOG_FILE: '/var/log/xray-vpn-control-plane/caddy-access.log',
      BACKUP_DIR: '/var/backups/xray-vpn-control-plane',
      BACKUP_HOST_DIR: '/opt/xray-vpn-control-plane/infra/backup/output',
    ...
    expect(env.BACKUP_HOST_DIR).toBe('/opt/xray-vpn-control-plane/infra/backup/output');
