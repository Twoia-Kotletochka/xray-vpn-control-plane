...
export const envSchema = z
  .object({
    ...
    SESSION_COOKIE_NAME: z.string().default('xray_vpn_admin'),
    ACCESS_TOKEN_TTL: z.string().default('15m'),
    REFRESH_TOKEN_TTL: z.string().default('30d'),
    BCRYPT_ROUNDS: z.coerce.number().int().min(10).max(14).default(12),
    LOGIN_RATE_LIMIT_TTL_MS: z.coerce.number().int().positive().default(60_000),
    LOGIN_RATE_LIMIT_MAX: z.coerce.number().int().positive().default(10),
    API_LOG_FILE: z.string().default('/var/log/xray-vpn-control-plane/api.log'),
    ...
    XRAY_ACCESS_LOG_FILE: z.string().default('/var/log/xray-vpn-control-plane/xray-access.log'),
    XRAY_ERROR_LOG_FILE: z.string().default('/var/log/xray-vpn-control-plane/xray-error.log'),
    ...
    WIREGUARD_CONFIG_PATH: z
      .string()
      .default('/var/lib/xray-vpn-control-plane/wireguard/generated/wg0.conf'),
    WIREGUARD_RUNTIME_DUMP_PATH: z
      .string()
      .default('/var/lib/xray-vpn-control-plane/wireguard/runtime/wg-show.dump'),
    ...
    WIREGUARD_LOG_FILE: z.string().default('/var/log/xray-vpn-control-plane/wireguard.log'),
    CADDY_ACCESS_LOG_FILE: z.string().default('/var/log/xray-vpn-control-plane/caddy-access.log'),
    BACKUP_DIR: z.string().default('/var/backups/xray-vpn-control-plane'),
